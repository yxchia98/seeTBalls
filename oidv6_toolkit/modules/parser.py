...
def parser_arguments():
    ...
    parser.add_argument('--yoloLabelStyle', required=False, action='store_true' ,help='write label in style <object-class-index> <x-mid> <y-mid> <width> <height> normalised in range between [0,1] to fit yolo labels archticture')
